...
/***********************************************************************************************************************/
#define CFG_HOLDER    0x66666671    /* Change this value to load default configurations */

/*DEFAULT CONFIGURATIONS*/

#define MQTT_HOST            "47.94.145.237" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            1883    // the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID        "xiaoniu_mqtt"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
...
#define STA_SSID "mqtt"    // your AP/router SSID to config your device networking
#define STA_PASS "652652652" // your AP/router password
